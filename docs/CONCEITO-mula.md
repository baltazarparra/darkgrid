...
4. **Pelo negro-terra** — massa escura, quase uma sombra com músculo; crina e
   cauda terminam em brasa.
5. **Pose de montaria prestes a galopar** — não estática; peso recolhido,
...
| `windup` | Corpo recolhe, patas afundam, coluna de fogo **incha e brilha** (overbright). | Telegraph visual do ataque especial. |
...
1. **Desenho vetorial supersampled 8×** (1536×1536): formas orgânicas de
   silhueta, pelo, arreio, ferraduras, toco e fogo.
